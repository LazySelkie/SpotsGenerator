<template>
  <div class="spot-input-min-max-wrapper">
    <s-input
      type="number"
      :label="props.label"
...
const emits = defineEmits(['input', 'minValue', 'maxValue']);
...
.spot-input-min-max-wrapper :deep(.input-wrapper) {
  display: flex;
  ...
  // чтобы убрать стрелочки вверх-вниз для изменения введенного числа
